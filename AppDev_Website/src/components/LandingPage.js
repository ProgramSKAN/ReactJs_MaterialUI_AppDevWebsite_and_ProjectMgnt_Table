        ...
        <Grid container direction="column" className={classes.mainContainer}>
            <Grid item>{/* ------------------Hero Block--------------------- */}
                <Grid container direction="row" justify="flex-end" alignItems="center">
                    <Grid xs item className={classes.heroTextContainer}>
                        ...
                        <div>Bringing West Coast Technology <br/>to Midwest</div>
                        </Typography>
            ...
            <Grid item>{/* ------------------Custom Software Block--------------------- */}
                <Grid container direction="row"  className={classes.serviceContainer} 
                    ...
                    <Grid item>
                        <img className={classes.icon} alt="custorm software icon" src={customSoftwareIcon}/>
                    </Grid>
                </Grid>
            </Grid>
            ...
            <Grid item>{/* ------------------Webites Block--------------------- */}
                <Grid container direction="row"  className={classes.serviceContainer} 
                    ...
                    <Grid item>
                        <img className={classes.icon} alt="webite icon" src={websitesIcon}/>
                    </Grid>
                </Grid>
            </Grid>
                        ...
                        <Grid item sm style={{marginLeft: matchesXS? 0 : matchesSM?"2em":"5em"}}>
                            <Grid container direction="column" style={{marginBottom:matchesXS?"10em":0}}>
                                ...
                                <Grid item>
                                    ...
                                    <span style={{marginRight:10}}>Learn More</span>     
                                    <ArrowForwardIcon style={{width:"0.7em",height:"0.7em",color:"white"}}/> 
                                    </Button>
                                </Grid>
                            </Grid>
                        </Grid>
